...
## Связанные темы каталога (без отдельной подпапки)

- **#71 OpenAI Prism** — облачный ИИ-workspace для исследователей (LaTeX + GPT, видящий весь проект). Локальный приватный аналог строится на этом стеке (Ollama + RAG), без отправки данных в облако — ключевое отличие для юр./мед. контекста.
